							...
							<div class="col-lg-6">
								<div class="p-5">
							        ...
							        if($this->session->flashdata('success')) {
							            echo '<div class="bg-success text-white mb-3 p-2">'.$this->session->flashdata('success').'</div>';
							        }
							        ?>

									<?php echo form_open(base_url().'admin/reset-password/index/'.$var1.'/'.$var2, array('class'=>'user')); ?>
										<div class="form-group">
											<input type="password" class="form-control form-control-user" name="new_password" placeholder="New Password">
										</div>
										<div class="form-group">
											<input type="password" class="form-control form-control-user" name="re_password" placeholder="Retype New Password">
										</div>
										<input type="submit" class="btn btn-primary btn-user btn-block" value="Submit" name="form1">
									<?php echo form_close(); ?>
								</div>
							</div>
						</div>
